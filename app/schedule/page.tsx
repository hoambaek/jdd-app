      ...
      <ScheduleTable>
        <thead>
          <tr>
            ...
            <TableHeader width="25%">전례</TableHeader>
            <TableHeader width="35%">교리 및 행사</TableHeader>
            <TableHeader width="25%">기타</TableHeader>
          </tr>
        </thead>
        <tbody>
          {scheduleData[selectedMonth].items.map((item, index) => (
            <TableRow key={index} $isEven={index % 2 === 0}>
              <TableCell>{item.date}일</TableCell>
              <TableCell>{item.liturgy}</TableCell>
              <TableCell>
                {item.event.includes('가정주일') ? (
                  <span className="text-red-600 font-semibold bg-red-50 px-2 py-1 rounded-md inline-flex items-center">
                  ...
                  <span className="text-blue-600 font-semibold bg-blue-50 px-2 py-1 rounded-md inline-flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="text-purple-600 font-semibold bg-purple-50 px-2 py-1 rounded-md inline-flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="text-amber-600 font-semibold bg-amber-50 px-2 py-1 rounded-md inline-flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="text-green-600 font-semibold bg-green-50 px-2 py-1 rounded-md inline-flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="inline-flex items-center">
                    ...
                    {item.event.includes('방학') && (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 flex-shrink-0 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {getCombinedReferences(selectedMonth) && (
            <TableRow $isEven={false} className="border-t-2 border-gray-200">
              <TableCell colSpan={4} className="py-4">
                <div className="font-semibold mb-2 text-indigo-700">이번 달 참조사항:</div>
                <div className="pl-2 border-l-2 border-indigo-300">
...
const MonthButton = styled.button<{ isSelected: boolean; color: { main: string; light: string; dark: string; text: string } }>`
  ...
  box-shadow: ${props => props.isSelected ? `0 2px 5px ${props.color.light}` : '0 1px 3px rgba(0, 0, 0, 0.02)'};
...
const TableCell = styled.td`
  ...
  &:nth-child(4) {
    color: ${props => props.children ? '#ff9500' : '#1c1c1e'};
    font-weight: ${props => props.children ? '600' : 'normal'};
  }
`;
